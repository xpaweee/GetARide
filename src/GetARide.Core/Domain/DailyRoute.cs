...
namespace GetARide.Core.Domain
{
    public class DailyRoute
    {
        ...
        public void AddPassengerNode(Passanger passenger, Node node)
        {
        ...
        public void RemovePassengerNode(Passanger passenger)
        {
            var passengerNode = GetPassengerNode(passenger);
            if(passengerNode == null)
            {
        ...
        private PassengerNode GetPassengerNode(Passanger passenger)
